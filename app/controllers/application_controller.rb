...
class ApplicationController < ActionController::Base
  ...
  def unsupported_browser
    t("#application.warnings.unsupported_browser", "Your browser does not meet the minimum requirements for Canvas. Please visit the *Canvas Guides* for a complete list of supported browsers.", :wrapper => view_context.link_to('\1', 'http://guides.hoodemo.com/s/2204/m/4214/l/41056-which-browsers-does-canvas-support'))
  end

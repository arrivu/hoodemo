    ...
    def self.default_links
      [
        ...
        },
        {
          ...
          :text => I18n.t('#help_dialog.search_the_canvas_guides', 'Search the LMS Guides'),
        ...
        },
        {
          ...
          :subtext => I18n.t('#help_dialog.report_problem_sub', 'If LMS misbehaves, tell us about it'),
          :url => '#create_ticket'
        }
      ]
    end

    ...
    def self.ndr_strings(subject, error)
      ...
      when IncomingMessageProcessor::ReplyToLockedTopicError
        ...
        ndr_body = I18n.t('lib.incoming_message_processor.locked_topic.body', <<-BODY, :subject => subject).strip_heredoc
          The message titled "%{subject}" could not be delivered because the discussion topic is locked. If you are trying to contact someone through LMS you can try logging in to your account and sending them a message using the Inbox tool.
        ...
        ndr_body = I18n.t('lib.incoming_message_processor.failure_message.body', <<-BODY, :subject => subject).strip_heredoc
          The message titled "%{subject}" could not be delivered.  The message was sent to an unknown mailbox address.  If you are trying to contact someone through LMS you can try logging in to your account and sending them a message using the Inbox tool.
